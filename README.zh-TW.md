...
<p align="center">
  <a href="https://github.com/KrelinnBios/NeoDBLite/releases"><img src="https://img.shields.io/github/v/release/KrelinnBios/NeoDBLite?style=flat-square&label=下載&color=2f6f73" alt="最新版本"></a>
...
- 發現瀏覽：按圖書、電影、劇集、音樂、遊戲、播客和演出查看趨勢內容。
- 條目搜尋：支援跨類目或限定類目搜尋，保留最近搜尋紀錄。
- 條目詳情：展示封面、標題、評分、簡介、標籤、外部來源連結和目前帳號的標記狀態。
- 標記管理：可設定書架狀態、評分、短評、標籤、可見性，並修改或刪除既有標記。
- 我的書架：按狀態、類目、標籤或標題關鍵字查看自己的標記，並提供日曆檢視。
- 收藏清單：查看自己的收藏單和清單內條目。
- 個人主頁：展示頭像、簡介、書架統計、最近完成條目和收藏單入口。
- 輔助設定：支援多套主題、三種介面語言、更新檢查、問題回饋和登出。
