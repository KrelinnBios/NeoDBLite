...
- 發現瀏覽：按圖書、電影、劇集、音樂、遊戲、播客和演出查看趨勢內容，長按條目可快速標記。
- 條目搜尋：支援跨類目或限定類目搜尋，保留最近搜尋紀錄，長按結果同樣支援快速標記。
- 條目詳情：展示封面、標題、簡介、標籤、外部來源連結、社群評分與點評，可設定書架狀態、評分、短評、標籤與可見性來標記該條目。
- 我的書架：按狀態、類目、標籤或標題關鍵字查看自己的標記，支援修改或刪除，並提供日曆檢視。
