...
- 條目搜尋：支援跨類目搜尋，也可以限定類目搜尋並分頁載入結果。
- 條目詳情：展示封面、標題、評分、簡介、標籤和當前帳號的標記狀態。
- 社群內容：在條目詳情中查看公開短評、評論、筆記等社群內容，並可跳轉網頁端查看更多。

### 標記管理

- 標記管理：支援設定想讀/在讀/讀過等書架狀態、0 到 10 評分、短評和可見性，也支援修改與刪除標記。
- 我的書架：按書架狀態分頁查看自己的標記，可按類目篩選，並支援日曆檢視輔助回顧。
- 個人主頁：展示帳號資訊、書架概覽、最近完成條目和常用設定入口。

### 輔助設定

- 主題切換：支援多套主題配色切換。
- 語言切換：支援简体中文、繁體中文、日本語和 English 介面。
- 應用更新：啟動時自動檢查新版本（可在設定頁關閉），支援應用內下載、喚起系統安裝器、下載失敗重試與手動下載入口。
