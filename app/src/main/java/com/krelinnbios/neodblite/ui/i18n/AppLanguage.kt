...
data class AppStrings(
    ...
    val createdCollections: String,
    val likedCollections: String,
...
val ZH_HANS = AppStrings(
    ...
    clearInput = "清空",
    collections = "我的合集",
    createdCollections = "我创建的",
    likedCollections = "我收藏的",
    itemsCount = "条目",
    noContent = "暂无内容",
    loading = "加载中…",
    loadingMore = "加载中…",
    ...
    updateFailed = "自动更新失败：",
    updateFailedHint = "请使用“手动下载”前往 GitHub Releases。",
...
val ZH_HANT = ZH_HANS.copy(
    ...
    updateFailed = "自動更新失敗：",
    updateFailedHint = "請使用「手動下載」前往 GitHub Releases。",
...
val EN = ZH_HANS.copy(
    ...
    createdCollections = "Created by me",
    likedCollections = "Liked by me",
    itemsCount = "items",
    ...
    updateFailedHint = "Use \"Manual download\" to open GitHub Releases.",
    ...
    themeBlueBlack = "Indigo · Dark",
    themeTealLight = "Teal · Light",
    themeTealDark = "Ink Green · Dark",
    themeSakura = "Sakura Pink · Light",
