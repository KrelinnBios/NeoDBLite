...
val ZH_HANS = AppStrings(
    ...
    instanceHost = "实例域名",
    login = "登录",
    loginHint = "将在浏览器中打开实例授权页，授权后自动返回应用。NeoDB 是去中心化平台，默认实例为 neodb.social，也可填写其它兼容实例。",
    detail = "详情",
    back = "返回",
    peopleCountSuffix = " 人",
    mark = "标记",
...
val ZH_HANT = ZH_HANS.copy(
    ...
    instanceHost = "實例網域",
    login = "登入",
    loginHint = "將在瀏覽器中開啟實例授權頁，授權後自動返回應用。NeoDB 是去中心化平台，預設實例為 neodb.social，也可填寫其他相容實例。",
    detail = "詳情",
    back = "返回",
    peopleCountSuffix = " 人",
    mark = "標記",
...
val JA = ZH_HANS.copy(
    ...
    login = "ログイン",
    loginHint = "ブラウザで認可ページを開き、認可後に自動でアプリへ戻ります。NeoDB は分散型プラットフォームです。既定のインスタンスは neodb.social ですが、互換インスタンスも指定できます。",
    detail = "詳細",
    back = "戻る",
    peopleCountSuffix = "人",
    mark = "記録",
...
val EN = ZH_HANS.copy(
    ...
    login = "Log in",
    loginHint = "The authorization page opens in your browser and returns to the app after approval. NeoDB is decentralized; neodb.social is the default, but compatible instances also work.",
    detail = "Details",
    back = "Back",
